...
$( document ).ready(function() {
    if(forwarding) {
    	...
    	$("#continueEditButton").attr("href", "https://github.com/bigdoods/bigdoods.github.com/edit/master/" + forwarding)
    } else {
...
<p><a class="button" href="https://github.com/bigdoods/bigdoods.github.com">Browse this site's source code</a></p>
